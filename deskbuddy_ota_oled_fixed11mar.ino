...
// ==================================================
// 2. EYE DATA (no Eye& function signatures used)
// ==================================================
struct EyeData {
  float x, y;
  float w, h;
...
void updatePomodoro() {
  ...
  if (now - pomodoroStart >= phaseDuration) {
    ...
    pomodoroStart = now;
    if (pomodoroBreak) currentMood = MOOD_HAPPY;
